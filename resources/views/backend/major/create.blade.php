    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>{{config('apps.major.createTitle') }}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{{config('apps.major.createTitle') }}</h5>
                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            ...
                                            {{-- <div class="form-group">
                                                <label for="fruits">Tổ hợp môn xét tuyển</label>
                                                <select id="fruits" name="subject_compo" data-placeholder="Chọn môn xét tuyển" multiple data-multi-select>
                                        ...
                                        <div class="col-lg-3">
                                             <div class="form-group">
                                                ...
                                                <div id="image-container" style="position: relative;">
                                                    <img src="{{ asset('upload/blog/df.jpg') }}" style="width: 100%" alt="" class="img-thumbnail" id="preview-image">
                                                    <button type="button" id="change-image-btn" class="btn btn-soft-dark" style="display: block; width: 280px">
                                                        Chọn ảnh đại diện ngành
                                                    </button>
                                    ...
                                    <div>
                                        <button class="btn btn-primary" type="submit"><strong>Thêm ngành</strong></button>
