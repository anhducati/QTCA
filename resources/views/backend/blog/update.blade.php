...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="image-container" style="position: relative;">
                                            ...
                                            <button type="button" id="change-image-btn" class="btn btn-soft-dark" style="display: block; width: 285px">
                                                Thay đổi ảnh
                                            </button>
                                    ...
                                    <div class="form-group">
                                        <div class="ibox-title">
                                            <h5>Nội dung bài viết EN</h5>
                                        </div>
                                        <textarea style="height: 300px"
                                                  name="contents_en" class="tinymce"
                                        >{{ htmlspecialchars_decode(old('contents_en', $blog->content_en)) }}</textarea>
                                    </div>
