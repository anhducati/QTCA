...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><strong>Tạo phiếu nhập</strong></li>
        </ol>
    </div>
        ...
        <div class="col-lg-8">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{ route('admin.import_receipts.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="note"
                                              class="form-control"
                                              rows="2"
                                              placeholder="Ghi chú thêm (lô hàng, chứng từ nhà cung cấp, ...)"
                                        >{{ old('note') }}</textarea>
                                    @error('note')
                                    <div class="error-danger">* {{ $message }}</div>
                                    @enderror
