        ...
        <td valign="top" align="center">
            <table class="container" width="600" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                    Trân trọng,  <br><strong>Trường Đại Học Thủy Lợi</strong>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    ...
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">ĐẠI HỌC THỦY LỢI<br/>Số 175 Tây Sơn - Quận Đống Đa – Thành phố Hà Nội
                        </div>
                        </div>
